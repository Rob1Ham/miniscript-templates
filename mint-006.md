...
<code>wsh(or_d(and_v(v:thresh(2,pkh($PAK_1$),a:pkh($PAK_2$),a:pkh($PAK_3$)),or_i(and_v(v:pkh($SAK$),after(`largest_epoch_timestamp`)),thresh(2,pkh($PK_1$),a:pkh($PK_2$),a:pkh($PK_3$),a:after(`smallest_epoch_timestamp`)))),and_v(v:thresh(2,pkh($RK_1$),a:pkh($RK_2$),a:pkh($RK_3$)),after(`between_epoch_timestamp`))))</code>
