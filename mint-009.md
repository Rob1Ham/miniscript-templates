...
<code>wsh(andor(multi(1,$PAK_1$,$PAK_2$),multi(2,$SAK_1$,$SAK_2$,$SAK_3$),and_v(v:thresh(1,pkh($RK_1$),a:pkh($RK_2$)),after(`recovery_epoch_timestamp`))))</code>

- Source Policy (FOR REFERENCE PURPOSES ONLY):
<code>"or(99@and(thresh(2,pk($SAK_1$),pk($SAK_e2$),pk($SAK_3$)),thresh(1,pk($PAK_1$),pk($PAK_2$))),and(after(`recovery_epoch_timestamp`),thresh(1,pk($RK_1$),pk($RK_2$))))"</code>
...
- `recovery_epoch_timestamp`: 1735603200 (December 31, 2024 00:00:00 UTC)
...
**Requirements Met:**
- ✅ Primary Agent: 1 of 2
- ✅ Secondary Agent: 2 of 3
- ✅ No timelock required

[Reference Testnet Transaction](https://mempool.space/signet/tx/704a052de0efc1ac273b2116a2eca87c9cb63e1462faaf8deea711ffca2f324c)
...
**Requirements Met:**
- ✅ Recovery: 1 of 2
- ✅ Timelock: After `recovery_epoch_timestamp`

[Reference Testnet Transaction](https://mempool.space/signet/tx/34cf9b59d96111cf54bf5814144c7769404818761bf112656c2015eaf2ea8447)
