...
|:-----:|:-----------------------:|:------------------------------------:|:----------------------:|:------------------------:|:------------------:|:------------------------------:|
| 1     | Default Spending Path   | $PK_1$, $PK_2$, $PK_3$ $PK_4$ $PK_5$ (3 of 3)      | AND                    | $_PAK_1$, $_PAK_2$, $_PAK_3$ | N/A              | None                          |
| 2     | Emergency Recovery Path | $_PAK_1$, $_PAK_2$, $_PAK_3$         | AND                    | $_SAK_1$                 | AND               | After (`smaller_epoch_timestamp`) |
| 3     | Sovereign Recovery Path | $RK_1$, $RK_2$, $RK_3$  $RK_4$ $RK_5$  | None                   | None                    | AND               | After (`larger_epoch_timestamp`)  |
...
[Reference Testnet
Transaction](https://mempool.space/testnet/tx/c76ca1efb56743c8d1c8a5bf8423bfef87395b0cc67bea5d5e0b1764e98683c6)
...
[Reference Testnet
Transaction](https://mempool.space/testnet/tx/993813cf2b64ba4a06775aa31b68ffd6f26fed647f3e399c66da2818b4b29844)
...
[Reference Testnet
Transaction](https://mempool.space/testnet/tx/e8952deebb911c7b5726a4a0b5d7c9257bf938a76016d9e7da00af24d4781b9a)
